...
RedirectMatch 301 ^/(docs)/([^/]+)/(v[0-9]\.[0-9]|latest-release)(|/.*)$ https://www.iguazio.com/$1//$3/$2$4
...
RedirectMatch 301 ^/(docs/[^/]+/tutorials/getting-started/trial-qs/)overview(|/.*)$ https://www.iguazio.com/$1$2
