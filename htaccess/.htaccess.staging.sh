...
RedirectMatch 301 ^/(docs)/v2.5(\.[0-9]|)(|/.*)$ https://igzdocsdev.wpengine.com/$1/latest-release/$3
...
RedirectMatch 301 ^/(docs/[^/]+)/intro/architecture.*$ https://www.igzdocsdev.wpengine.com/$1
...
RedirectMatch 301 ^/(docs/[^/]+/tutorials/getting-started/trial-qs/)overview(/|)(.*)$ https://igzdocsdev.wpengine.com/$1$2$3
